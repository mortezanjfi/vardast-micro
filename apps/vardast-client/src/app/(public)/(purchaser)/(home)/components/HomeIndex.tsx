...
import DesktopHomeIndex from "@/app/(public)/(purchaser)/(home)/components/DesktopHomeIndex"
import MobileHomeIndex from "@/app/(public)/(purchaser)/(home)/components/MobileHomeIndex"

// const DesktopHomeIndex = dynamic(
//   () => import("@/app/(public)/(purchaser)/(home)/components/DesktopHomeIndex"),
//   {
//     ssr: false
//   }
// )
...
//   () => import("@/app/(public)/(purchaser)/(home)/components/MobileHomeIndex"),
//   {
//     ssr: false
//   }
// )
...
const PwaNotificationProvider = dynamic(
  () => import("@vardast/provider/PwaNotificationProvider"),
  {
    ssr: false
  }
)
