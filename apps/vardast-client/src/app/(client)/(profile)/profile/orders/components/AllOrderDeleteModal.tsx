        ...
        <div className="flex">
          ...
          <div>
            ...
            <p className="my-4 leading-loose">
              {t(
                "common:are_you_sure_you_want_to_delete_entity_this_action_cannot_be_undone_and_all_associated_data_will_be_permanently_removed",
                {
                  entity: "تمام کالاهای این سفارش"
                }
              )}
            </p>
            <AlertDialogFooter>
