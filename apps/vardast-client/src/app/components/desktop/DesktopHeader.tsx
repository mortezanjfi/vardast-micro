...
const DesktopHeader = (_: DesktopHeaderProps) => {
  ...
  return (
    <header className="sticky right-0 top-0 z-30 border-b bg-alpha-white px-6">
      <div className="container grid grid-cols-12 grid-rows-2 items-center gap-y py-7 md:grid-rows-1 md:gap-x-12">
        ...
        <div className="col-span-12 row-start-2 h-full md:col-span-4 md:row-start-1 lg:col-span-6">
