    ...
    <CardContainer title="افزودن قیمت">
      <div className="flex items-center justify-between border-b py-5">
        <div className="flex flex-col gap-2">
          ...
          <p>
            لطفا قیمت کالاهای سفارش را وارد کرده و در صورت تایید نهایی، سفارش را
            ثبت نمایید
          </p>
        </div>
              ...
              (product) =>
                product && (
                  <tr key={product.id}>
                    ...
                    <td className="w-[129px] border-r-0.5">{product.brand}</td>
                    <td className="w-[129px] border-r-0.5">{product.unit}</td>
                    <td className="w-[129px] border-r-0.5">{product.value}</td>
