...
const BrandsOrSellersContainer: React.FC<IBrandsOrSellersContainer> = ({
  ...
  const classNameByType = {
    ...
    [BrandContainerType.BRANDS_PAGE_LIST]:
      "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 sm:divide-y-0 divide-y divide-alpha-300 px-6 pb-5 md:px-0 bg-alpha-white sm:gap-7 sm:py-5",
