...
const OrderProductsInnerLayout: React.FC<IOrderProductsInnerLayout> = ({
  ...
  return (
    <div className="flex min-h-full flex-col-reverse justify-end gap-x-9 gap-y-1 bg-alpha-white p-0.5 px-6 sm:px-0 2xl:grid 2xl:grid-cols-4">
      <div className="col-span-3 flex flex-1 flex-col sm:h-full">
        {children}
      </div>
      {/* {!isMobileView && (
        <OrderInfoCard
